...
import SearchBox from "../../application-ui/SearchBox";
...
export default function NavbarTop() {
  ...
  return (
    <>
      ...
      {/*<!-- Header --> */}
      <header className="border-b-1 sticky top-0 z-20 w-full border-b border-slate-200 bg-white/90 shadow-lg shadow-slate-700/5 after:absolute after:top-full after:left-0 after:z-10 after:block after:h-px after:w-full after:bg-slate-200 lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden">
        <div className="relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
          ...
          >
            ...
            <ul
              ...
              className={`absolute top-0 left-0 z-[-1] h-[28.5rem] w-full justify-center overflow-hidden  overflow-y-auto overscroll-contain bg-white/90 px-8 pb-12 pt-24 font-medium transition-[opacity,visibility] duration-300 lg:visible lg:relative lg:top-0  lg:z-0 lg:flex lg:h-full   lg:overflow-visible lg:bg-white/0 lg:px-0 lg:py-0  lg:pt-0 lg:opacity-100 ${
                isToggleOpen
            ...
            <div className="ml-auto flex items-center justify-end px-6 lg:ml-0 lg:flex-1 lg:p-0 divide-x divide-gray-300 gap-5">
              ...
              <div className="flex gap-5 pl-5">
                <Link
                  href="#"
                  className="flex p-2 border border-green-600 rounded-md"
                >
                  <span className="text-sm font-poppins font-normal text-green-600">
                    Login
                  </span>
                </Link>
                <Link href="#" className="flex p-2 bg-green-600 rounded-md">
