            ...
            <div className="ml-auto flex items-center justify-end px-6 lg:ml-0 lg:flex-1 lg:p-0 divide-x divide-gray-300 gap-5">
              ...
              <div className="flex gap-5 pl-5 items-center">
                {token ? (
                  ...
                  <Link
                    href="/auth"
                    className="flex p-2 border border-green-600 rounded-md group hover:bg-green-600"
                  >
                    <span className="text-sm font-poppins font-normal text-green-600 group-hover:text-white">
                      Login
                    </span>
                  </Link>
                )}
