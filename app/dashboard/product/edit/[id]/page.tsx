...
const EditProduct = () => {
  ...
  const schema = Yup.object({
    ...
    productImage: Yup.mixed()
      .nullable()
      .test("is-valid-type", "File only image", (value: any) => {
        if (!value) {
          return true;
        }
        return (
      ...
      .test("is-valid-size", "Maximum file upload 2MB", (value: any) => {
        if (!value) {
          return true;
        }
  ...
  useEffect(() => {
    if (currentProduct) {
      ...
      setVariants(currentProduct.productVariant);
    }
  }, [currentProduct]);
        ...
        <>
          <form onSubmit={formik.handleSubmit}>
            <div className="flex mb-3 border-b p-2 justify-between items-center">
              <h3 className="font-poppins font-bold">Edit Produk</h3>
              <BtnSubmit
                label="Simpan"
